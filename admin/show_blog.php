...
if (isset($_POST['submit'])) {
    $block_active = trim($_POST['block_active']);
      
 
    $myarray = array("block_active" => $block_active);

    try {

        if ($user->block_item_insert($myarray)) {
            $user->redirect('show_blog.php');
         }
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							<span class="title elipsis">
								<strong>Show Blog</strong> <!-- panel title -->
							</span>
                ...
                <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                        <div class="form-group mb-n">
                            <label for="First Name" class="col-sm-2 control-label label-input-lg">Show Blog </label>
                            <div class="col-sm-8">
                                <label class="checkbox weight-300">
                                                                            <?php if($block_show['block_active'] == 1) { ?>
                                                                            <input type="checkbox" name="block_active" checked="checked" value="1">
                                                                              <?php
                                                                          } else {  ?>
                                                                            <input type="checkbox" name="block_active"  value="1">
                                                                            <?php  } ?>
										<i></i> Show me in Site Menu
									</label>
                             </div>
                        </div>
