								...
								<tbody>
								  ...
								  <?php foreach ($blog as $value) { ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $value['metakey']; ?></td>

                                                                        <td><?php echo $value['metadescription']; ?></td>

                                                                        <td><a href="blog_update.php?id=<?php echo $value['id']; ?>">Edit</a> | <a href="blog_show.php?id=<?php echo $value['id']; ?>">Delete</a></td>
