 ...
 error_reporting(0);
  ...
  $users = $user->getvalue();
 // print_r($users); 
$get_hotest_allmembers = $user->get_hotest_allmembers();
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							<span class="title elipsis">
								<strong>ALL HOT USERS</strong> <!-- panel title -->
							</span>
							...
							<table class="table table-striped table-bordered table-hover" id="sample_1">
								<thead>
									 <tr>
                                                                            ...
                                                                            <th>KikID</th>
                                                                            <th>Gender</th>
                                                                            <th>Total Hot Vote Received</th>
                                                                            <th>Total Hot Vote Given</th>
                                                                        </tr>
								</thead>
								<tbody>
								 <?php foreach ($get_hotest_allmembers as $profile){ ?>
                                                                    <tr>
                                                                        <td><?php echo $profile['id'];  ?></td>
                                                                        <td><?php echo $profile['fname'];  ?> <?php echo $profile['lname'];  ?></td>
                                                                        <td><?php echo $profile['username'];  ?></td>
                                                                        <td><?php echo $profile['kikuser'];  ?></td>
                                                                        <td><?php if ($profile['gender'] == 1){  ?> Guy <?php }else{ ?> Girl <?php } ?></td>
                                                                        <td><?php echo $profile['votecount'];  ?></td>
                                                                        <td><?php echo $profile['given'];  ?></td>
                                                                     </tr>
                                                                    <?php } ?>
								</tbody>
							</table>
