...
error_reporting(0);
  ...
  $users = $user->getvalue_suspenduser();
...
<?php include 'part/header.php'; ?>
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							<span class="title elipsis">
								<strong>ALL KIK USERS</strong> <!-- panel title -->
							</span>
        ...
        <tr class="active">
          ...
          <td><?php echo $user['fname']; echo $user['lname']; ?></td>
          <td><?php echo $user['username']; ?></td>
          <td><?php echo $user['kikuser']; ?></td>
          ...
          <td>
              <?php  $id = array(2,1); ?>
              <a href="edit_users.php?id=<?php echo $user['username']; ?>">Edit</a> |
              <a href="users.php?id=<?php echo $user['username']; ?>">Delete</a> |
              <?php if($user['suspended'] == 1){ ?>
              <a href="users.php?ssid=<?php echo $user['username']; ?> && sid=<?php echo $id[0]; ?>">Suspended</a>
              <?php }else {?>
              <a href="users.php?ssid=<?php echo $user['username']; ?> && sid=<?php echo $id[1]; ?>">Active</a>
              <?php } ?>
          </td>
        </tr>
        <?php  } ?>
