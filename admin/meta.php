...
if (isset($_POST['submit'])) {
    ...
    $myarray = array("metakey" => $metakey, "metadescription" => $metadescription);

    try {

        if ($user->meta_insert($myarray)) {
            $user->redirect('meta.php');
         }
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							<span class="title elipsis">
								<strong>META ADD</strong> <!-- panel title -->
							</span>
                ...
                <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                        <div class="form-group mb-n">
                            <label for="metakey"   class="col-sm-2 control-label label-input-lg">Meta Key</label>
                            <div class="col-sm-10">
                                <input type="text" style="height: 45px;" name="metakey" class="form-control" value="<?php echo $meta['metakey']; ?>" id="largeinput" placeholder="Meta Key">
                            </div>
                        </div>
                        <div class="form-group mb-n">
                            <label for="metadescription"   class="col-sm-2 control-label label-input-lg">Meta Description</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="metadescription"  data-height="200" value="<?php echo $meta['metadescription']; ?>" data-lang="en-US"><?php echo $meta['metadescription']; ?></textarea>
                            </div>
                        </div>
