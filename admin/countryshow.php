...
$users = $user->getvalue();
$get_country = $user->getvalue_country();
if(!$user->is_loggedin())
{
 $user->redirect('index.php');
  ...
  if (isset($_GET['q'])){
   ...
   if (isset($_GET['id'])){
        $user->delete_country();
        header("location:country_show.php");
   }  
   ?>
					...
					<div id="panel-1" class="panel panel-default">
						...
						<div class="panel-heading">
							...
							<span class="title elipsis">
								...
								<strong>ALL COUNTRY</strong> <!-- panel title -->
...
<a class="btn btn-success text-right" href="add_country.php">Country ADD</a>
							...
							<table class="table table-striped table-bordered table-hover" id="sample_1">
								...
								<tbody>
								  ...
								  <?php foreach ($get_country as $value) { ?>

                                                                    <tr>

                                                                        <td><?php echo $value['counrty_name']; ?></td>

                                                                        <td><?php echo $value['country_code']; ?></td>

                                                                        <td><a href="country_show.php?id=<?php echo $value['id']; ?>">Delete</a></td>
