...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        if ($user->country_insert($myarray)) {
            $user->redirect('countryshow.php');
         }
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							<span class="title elipsis">
								<strong>ADD COUNTRY</strong> <!-- panel title -->
							</span>
						...
						<div class="panel-body">
                                                    <a class="btn btn-success text-right" href="countryshow.php">Country Show</a>
							<!--
                ...
                <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                        <div class="form-group mb-n">
                            <label for="First Name" class="col-sm-2 control-label label-input-lg">Country Name</label>
                            <div class="col-sm-8">
                                <input type="text" name="name" value="" class="form-control input-lg" id="largeinput" placeholder="Country Name">
                            </div>
                        </div>
                        <div class="form-group mb-n">
                            <label for="Last Name"   class="col-sm-2 control-label label-input-lg">Country Code</label>
                            <div class="col-sm-8">
                                <input type="text" name="code" value="" class="form-control input-lg" id="largeinput" placeholder="Country Code">
                            </div>
                        </div>
