...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        if ($user->blog_insert($myarray)) {

            $user->redirect('add_blog.php');
					...
					<div id="panel-1" class="panel panel-default">
						...
						<div class="panel-heading">
							...
							<span class="title elipsis">
								...
								<strong>BLOG ADD</strong> <!-- panel title -->
                    ...
                    <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-n">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" name="title" value="" class="form-control input-lg" id="largeinput" placeholder="Title">
                        ...
                        <div class="form-group mb-n">
                            ...
                            <textarea class="summernote form-control" name="description" data-height="200" data-lang="en-US"></textarea>                            </div>
                        ...
                        <div class="form-group mb-n">
                            ...
                            <label for="Last Name"   class="col-sm-2 control-label label-input-lg">Meta KeyWord</label>

                            <div class="col-sm-10">

                                <input type="text" value="" name="metakey" class="form-control input-lg" id="largeinput" placeholder="Meta KeyWord">
                        ...
                        <div class="form-group mb-n">
                            ...
                            <label for="Last Name"   class="col-sm-2 control-label label-input-lg">Meta Description</label>

                            <div class="col-sm-10">

                                <textarea class="form-control" name="metadescription"  data-height="200" data-lang="en-US"></textarea>
