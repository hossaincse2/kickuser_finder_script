 ...
 if(isset($_POST['submit']))
{
        ...
        $myarray = array("fullname"=>$fullname,"user_name"=>$user_name,"user_email"=>$user_email,"user_pass"=>$user_pass);
    if($fullname=="") {
      $fullnameerror = "provide Date Name !"; 
   }
   else if($user_name=="") {
      $user_nameerror = "provide User Name !"; 
   }
   else if($user_email=="") {
      $user_emailerror = "provide Email !"; 
   }
   else if($user_pass=="") {
      $user_passerror = "provide Password !"; 
   }
   ...
   else
   {
      try
      {
             if($user->register_admin($myarray))
            {
                //$setting->redirect('sign-up.php?joined');
                $user->redirect('adminshow.php');
             }
         }
                ...
                <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                        <div class="form-group mb-n">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="fullname" value="" class="form-control input-lg" id="largeinput" placeholder="Full Name">
                            </div>
                        </div>
                        <div class="form-group mb-n">
                            <label for="Last Name"   class="col-sm-2 control-label label-input-lg">User Name</label>
                            <div class="col-sm-8">
                                <input type="text" name="user_name" value="" class="form-control input-lg" id="largeinput" placeholder="Username">
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-n">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="user_email" value="" class="form-control input-lg" id="largeinput" placeholder="Email">
                            </div>
                        </div>
                         ...
                         <div class="form-group mb-n">
                            ...
                            <div class="col-sm-8">
                                <input type="password"  name="user_pass" value="" class="form-control input-lg" id="largeinput" placeholder="Password">
                            </div>
                        </div>
