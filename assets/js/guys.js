           ...
           success: function(html) {
               ...
               if(result1){
                   ...
                   $(loderimg).hide();
                    ...
                    $(".loader_message2").html('<button data-offset=0 data-atrs="all"  class="btn btn-default load_buton" type="button">Load More Users</button>').show();
                         } else { 
                       // $("button[data-attrs='all']").html('<button data-atr="nodata" class="btn btn-default load_buton" type="button">No More Users</button>');
               ...
               if(result3){
                   ...
                   if (html.contains("div")) {
                      //   $("button[data-attrs='all']").html('<button data-atr="nodata" class="btn btn-default load_buton" type="button">No More Users</button>');
                    $(".loader_message9").html('<button data-offset=0 data-atrs="girl"  class="btn btn-default load_buton" type="button">Load More Users</button>').show();
                         } else { 
                       // $("button[data-attrs='all']").html('<button data-atr="nodata" class="btn btn-default load_buton" type="button">No More Users</button>');
