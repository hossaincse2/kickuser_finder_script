...
$.ajax({
           ...
           success: function(html) {
               var substr1='<!--<h1>hotestuser</h1>-->';
               var result1 = html.indexOf(substr1) > -1;
               var substr2='<!--<h1>hotestguy</h1>-->';
               var result2 = html.indexOf(substr2) > -1;
               var substr3='<!--<h1>hotestgirl</h1>-->';
               ...
               if(result1){
                   ...
                   $(loderimg).hide();
                    ...
                    $(".loader_message7").html('<button data-offset=0 data-atrs="all"  class="btn btn-default load_buton" type="button">Load More Users</button>').show();
                         } else { 
                       // $("button[data-attrs='all']").html('<button data-atr="nodata" class="btn btn-default load_buton" type="button">No More Users</button>');
                ...
                if(result2){
                  ...
                  if (html.contains("div")) {
                      //   $("button[data-attrs='all']").html('<button data-atr="nodata" class="btn btn-default load_buton" type="button">No More Users</button>');
                    $(".loader_message5").html('<button data-offset=0 data-atrs="guy"  class="btn btn-default load_buton" type="button">Load More Users</button>').show();
                         } else { 
                       // $("button[data-attrs='all']").html('<button data-atr="nodata" class="btn btn-default load_buton" type="button">No More Users</button>');
               ...
               if(result3){
                   ...
                   if (html.contains("div")) {
                      //   $("button[data-attrs='all']").html('<button data-atr="nodata" class="btn btn-default load_buton" type="button">No More Users</button>');
                    $(".loader_message6").html('<button data-offset=0 data-atrs="girl"  class="btn btn-default load_buton" type="button">Load More Users</button>').show();
                         } else { 
                       // $("button[data-attrs='all']").html('<button data-atr="nodata" class="btn btn-default load_buton" type="button">No More Users</button>');
