...
if (count($results) > 0) {
  ...
  foreach ($results as $profile) { ?>
     <div class="row user">
          ...
          <li class="dropdown">
           <a data-whatever="<?php echo $profile['kikuser']; ?>" data-target="#exampleModal10" data-toggle="modal" style="background-color: #80bf41; color: white; border:none" class="border_user current" href="">
            <b>Ask For Kik Id</b>
           </a>
         </li>
       </ul></div>
  ...
  <div class="modal-dialog" role="document">
    ...
    <?php }else{ ?> 
        ...
        <div class="row user">
            ...
            <div class="col-md-5 view_content"><ul class="nav navbar-nav navbar-nav3 ul">
                    <li><a href="index/profile/<?php echo $profile['username'] ?>" class="border_user">View Profile</a></li>
          <li class="dropdown">
           <a data-whatever3="<?php echo $profile['kikuser']; ?>" data-target="#example10" data-toggle="modal" style="background-color: #80bf41; color: white; border:none" class="border_user current" href="">
            <b>Ask For Kik Id</b>
           </a>
         </li>
       </ul></div>
   ...
   <div class="modal fade" id="example10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
