  ...
  foreach ($results as $profile) { ?>
     ...
     <div class="row user">
         ...
         <li class="dropdown">
           ...
           <a data-whatever="<?php echo $profile['kikuser']; ?>" data-target="#exampleModal5" data-toggle="modal" style="background-color: #80bf41; color: white; border:none" class="border_user current" href="">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title5" id="exampleModalLabel">Kik UserName</h4>
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
             ...
             <input class="form-control" id="kik5" name="" id="message-text" />

          </div>

          <p>

               Copy and paste <span id="copykik5"></span> Kik username or go directly to their <a target="_blank" id="w3"  href="http://kik.me/u/">Kik online profile</a>.
    ...
    <?php }else{ ?> 
        ...
        <div class="row user">
         ...
         <li class="dropdown">
           ...
           <a data-whatever3="<?php echo $profile['kikuser']; ?>" data-target="#example5" data-toggle="modal" style="background-color: #80bf41; color: white; border:none" class="border_user current" href="">
   ...
   <div class="modal fade" id="example5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
...
$('#exampleModal5').on('show.bs.modal', function (event) {
 ...
 modal.find('.modal-title5')

 modal.find("#w3").attr("href", "http://kik.me/u/" + recipient);

 modal.find('#kik5').val(recipient);
 modal.find('#copykik5').html(recipient);

 
});


   $('#example5').on('show.bs.modal', function (event) {
